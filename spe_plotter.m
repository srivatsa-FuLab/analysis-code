...
%-------------------------------------------------------------------------
% %User options
stiched_spectra = 0;  %is this a winspec stitched spectra (i.e pixels > ccd_width ?)
...
for n=1:length(files)
    ...
    if try_fit
        ...
        try
            f1 = fit(data_x(m_ind-100:m_ind+100), data_y(m_ind-100:m_ind+100), ...
                lorentz, 'StartPoint',[100, start_x, 10*dx, 500,1], ...
                'Upper', [m, start_x + 10*dx, 50*dx, 2*m,1000], ...
